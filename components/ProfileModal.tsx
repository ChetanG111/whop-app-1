...
const MenuOption: React.FC<MenuOptionProps> = ({ icon, label, onClick }) => (
    ...
    >
        ...
        <ChevronRight
            size={20}
            className="text-gray-400 dark:text-zinc-600 group-hover:text-gray-600 dark:group-hover:text-zinc-400 transition-colors duration-200"
        />
    </button>
);
...
export const ProfileModal: React.FC<ProfileModalProps> = ({
    ...
    // Sync temp state when entering edit view
    useEffect(() => {
        ...
        <div className="fixed inset-0 z-50 pointer-events-none">
            ...
            >
                    ...
                    >
                        ...
                        <div className="w-1/2 h-full flex flex-col">
                            <div className="flex items-center justify-between p-6 pb-2 shrink-0">
                                ...
                                <button
                                    onClick={onClose}
                                    className="text-gray-400 dark:text-zinc-400 hover:text-black dark:hover:text-white transition-colors active:scale-90"
                                >
                                    <X size={24} />
                                </button>
                            </div>
                            ...
                            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-zinc-800 shrink-0">
                                <div className="flex items-center">
                                    <button
                                        ...
                                        className="mr-4 w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 dark:hover:bg-zinc-900 text-gray-500 dark:text-zinc-400 hover:text-black dark:hover:text-white transition-colors active:scale-90"
                                    >
                                        <ChevronLeft size={24} />
                                    </button>
                                        ...
                                        <div className="relative mb-8 group cursor-pointer" onClick={() => avatarInputRef.current?.click()}>
                                            ...
                                            <div className="w-28 h-28 rounded-full bg-gray-200 dark:bg-zinc-800 border-4 border-white dark:border-zinc-900 overflow-hidden shadow-xl">
                                                {tempAvatar ? (
                                                    ...
                                                    <div className="w-full h-full flex items-center justify-center text-gray-400 group-hover:opacity-60 transition-opacity">
                                                        <User size={48} />
                                                    </div>
                                                )}
                                            </div>
                                            <div className="absolute inset-0 flex items-center justify-center">
                                                <Camera
                                                    size={24}
                                                    className="text-white opacity-0 group-hover:opacity-100 transition-opacity drop-shadow-md transform group-hover:scale-110 duration-200"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="w-full space-y-6">
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:ring-0 focus:border-2 focus:border-dotted focus:border-black dark:focus:border-white transition-all"
                                                />
                                            </div>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:ring-0 focus:border-2 focus:border-dotted focus:border-black dark:focus:border-white transition-all resize-none h-24"
                                                />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full">
                                        ...
                                        <div className="mt-8">
                                            ...
                                            >
                                                ...
                                                <ChevronRight
                                                    size={20}
                                                    className="text-rose-300 dark:text-rose-700 group-hover:text-rose-500 dark:group-hover:text-rose-500 transition-colors duration-200"
                                                />
                                            </button>
                                        </div>
                                    </div>
                ...
                <ConfirmDialog
                    ...
                    message="This action cannot be undone. All your workout logs, streaks, and profile settings will be permanently removed."
                    confirmLabel="Delete"
