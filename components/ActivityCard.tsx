  ...
  return (
    ...
    >
      <div className="flex flex-col min-w-0 flex-1">
        ...
        {onClick && (
          <div className="mt-2 flex items-center text-brand-500 text-xs font-bold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
