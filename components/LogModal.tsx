                        ...
                        <div className="max-h-[240px] overflow-y-auto no-scrollbar p-1">
                          {Object.values(WorkoutType).map((t) => (
                            <button
                              ...
                              className={`w-full flex items-center justify-between px-4 py-3 rounded-lg text-sm font-medium transition-colors ${workoutType === t
          ...
          <div className="w-auto h-12 flex items-center justify-end">
            {step === 4 ? (
              ...
              <button
                onClick={handleNext}
                disabled={!canProceed()}
                className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors active:scale-90 ${canProceed()
